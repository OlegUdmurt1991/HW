...
Формат вывода:Неделя {номер недели}:День - ЧислоДень - Число...P.S День должен отображать число месяца и название дня недели,
 Неделя должна отображать номер недели относительно начала года и как положено - 7 дней, при создании объектов недели и выводе на экран ориентироваться на календарь 2022 года. Например : 2 неделя 2022 года - Понедельник 3 число , Вторник 4 число и тд. */public class Main {
